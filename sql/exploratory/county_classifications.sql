...
put 'file://c:/users/matth/downloads/county classifications.csv' @analyst_data.%county_classifications 
parallel = 99
auto_compress = TRUE
overwrite = TRUE
;
...
COPY INTO analyst_data.county_classifications
FROM @analyst_data.%county_classifications
file_format = (
type = 'CSV'
compression = 'gzip'
field_delimiter = '\t'
